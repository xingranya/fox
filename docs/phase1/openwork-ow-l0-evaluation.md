...
最终回归为 App 370 项通过，Desktop 100 项通过、1 项平台条件跳过；App、Desktop、Server、Orchestrator 类型检查通过。F1.9 已完成。后续 F1.10 与 F2.1-F2.7 也已通过，当前总进度为 24/49，活动任务是 F2.8；内部包尚未签名和公证，不能向员工分发。
