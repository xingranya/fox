...
> 员工客户端：基于 OpenWork 的公司定制版，最终发行名待定<br>
> 员工安装数量：1<br>
...
```text
员工
  -> Brand Project OS Desktop（基于 OpenWork）
...
| 入口 | 使用者 | 能力 | 明确禁止 |
|:---|:---|:---|:---|
| Brand Project OS Desktop | 员工 | 状态、资料、会议、证据、Proposal、AI 工作、流程状态和诊断 | 直连 PostgreSQL/S3、从 Session 推导正式状态 |
