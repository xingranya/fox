...
> 状态：FoxWork 本地与服务器运行共同使用的生效协议<br>
...
OpenWork Den 只负责账号、组织和 AI 能力分发，不参与本协议中的事实分类、工作模式、Task Packet 内容或人工批准。Den Skill 可以引用本协议的版本和工作法，但不能保存项目当前状态、原文或替代 Brand OS 权威事件。
